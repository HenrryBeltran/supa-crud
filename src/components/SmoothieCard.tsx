  ...
  return (
    <div className="grid grid-cols-2 grid-rows-2 rounded-md border border-neutral-100 bg-white p-4 shadow-lg lg:p-6">
      <div className="col-span-2 mb-3">
        ...
        <p className="mt-1 text-sm font-light text-sky-950 lg:text-base">{smoothie.method}</p>
      ...
      <div className="mt-auto h-min">
        <h3 className="font-extrabold text-sky-600/80 lg:text-lg">{smoothie.rating}</h3>
      ...
      <div className="ml-auto mt-auto flex h-min gap-2">
        ...
        >
          <svg viewBox="0 96 960 960" className="h-5 w-5 fill-sky-600 hover:fill-sky-900">
